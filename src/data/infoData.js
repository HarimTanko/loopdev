...
export const InfoData = {
  ...
  paragraphTwo:
    'We know how to add value to any kind of project, and we always do.',
  paragraphThree: 'Our development projects have an average ROI of 37% ',
  paragraphFour: 'Our Maximum ROI to date is 57%, Actions or Open Market',
  imageOne: InvestImage1,
  imageTwo: InvestImage2,
